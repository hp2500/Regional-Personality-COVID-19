...
save(ger_list_results, file="ger_list_results_robustness_check.RData")
```
...
save(ger_agg_fixed_window, file="ger_agg_robustness_check.RData")
```

```{r}
write_csv(df_ger_slope_prev, 'df_ger_slope_prev_robustness_check.csv')
```
